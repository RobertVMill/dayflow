  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 -mx-2">
      ...
      <div className="space-y-3">
        <div>
          <label className="block text-[#8B1E1E] px-2 mb-1 text-base">
            I'm so blessed today for
          </label>
          <textarea
            value={entry.blessings}
            onChange={(e) => handleChange('blessings', e.target.value)}
            className="w-full h-24 bg-black/30 border-y border-[#8B1E1E]/20 p-2 text-white text-base"
      ...
      <div className="flex justify-end px-2">
        <button
          type="submit"
          disabled={isSaving}
          className="w-full bg-[#8B1E1E] text-white py-3 text-base disabled:opacity-50 active:bg-[#661616]"
        >
